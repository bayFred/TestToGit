...
<html>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input class="form-control" name="pass" id="exampleInputPassword1" placeholder="Password" type="password">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="exampleTextarea" rows="3" name="text1"></textarea>
    </div>
<!--    <div class="form-group">
